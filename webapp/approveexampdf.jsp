...
<body>
<form action="appudateexam.jsp">
    <div class="container-wrapper">
        <div class="overlay"></div>
        <div class="container">
            <h1>Pending Academic Pdfs Approvals</h1>

<%
ExamPdfCrud b = new ExamPdfCrud();
ArrayList<ExamPdf> list = b.read();
...
%>
 <table>
                       ...
                       <td><%=p.getDescription() %></td>
                        ...
                        <td class="action-btns">
                         <input type="submit"  class="approve-btn" value="Approve">
                            ...
                            <button class="reject-btn"> <a href="appdeleteexam.jsp?title=<%= p.getTitle() %>&rollno=<%= p.getRollno() %>">Reject</a></button>
                        </td>
                    </tr>
                <%
                        }
    ...
    %>
    <p>No Academics pdfs available .</p>
    <%
                }
    %>
</body>
