<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.sai.connect.BookCrud, java.util.ArrayList, com.sai.model.Book" %>
...
<%
    ...
    ArrayList<Book> list = b.read(branch);
%>
...
<div class="container">
    ...
    <a href="add.html" class="add-button">Add Book</a>

    <% if (list != null && !list.isEmpty()) { %>
        <div class="row" id="book-list">
            <% for (Book p : list) {
                if (p != null && "yes".equals(p.getApprove())) { %>
                    <div class="col-md-4 d-flex justify-content-center">
                        <div class="card">
                            <div class="card-body text-center">
                                <a class="card-title" href="<%= p.getUrl() %>" target="_blank">
                                    <%= p.getTitle() %>
                                </a>
                                <h5 class="card-subtitle mb-2"><%= p.getAuthor() %></h5>
                                <p class="card-text">Available: <%= p.getAvailable() %></p>
                            </div>
                        </div>
                    </div>
            <% } } %>
