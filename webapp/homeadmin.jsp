...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Dropdown Menu for Approve Books */
        .dropdown {
            display: none;
            position: absolute;
...
<body>
            ...
            <ul>
              <li><a href="about.html">About</a></li>
                ...
                <li><a href="#">Projects</a>
                    <div class="dropdown">
                       <a href="project.jsp?branch=trending projects">TRENDING</a>	
                ...
                <li><a href="#">News</a>
                    <div class="dropdown">
                        ...
                        <a href="newsupdate.jsp">Add News</a>      
                    </div>
                </li>
               <li><a href="#">Approve</a>
                    <div class="dropdown">
                        <a href="approval.jsp" >Books</a>
                        <a href="appproject.jsp" >Projects</a>
                        <a href="approveexampdf.jsp" >Academics</ a>
                         <a href="appmagzine.jsp" >Magzines</a>
                    </div>
                </li>
                <li><a href="placeme.html">Placements</a></li>
                <li><a href="booklogadmin.jsp">Book Log</a></li> <!-- Added Book Log here -->
            </ul>
        </nav>
        <div class="user-icon">
    ...
    <!-- Cards section for additional features -->
    <section class="cards-container">
        ...
        <div class="card">
            <img src="images/conlogo.jpg" alt="Placements">
            <h3>ApproveBooks</h3>
            <p>Books are important than water to save a life of a earth.</p>
            <a  href="approval.jsp"><button>Explore</button></a>
        </div>
    </section>
    <script>
