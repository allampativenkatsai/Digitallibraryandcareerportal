<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.sai.connect.MagzineCrud,com.sai.connect.Magzine,java.util.ArrayList"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
MagzineCrud p = new MagzineCrud();
ArrayList<Magzine> a = p.read();

%>

<div class="container">
    <h2>MAGZINES</h2>
 <a href="addm.html" class="add-button">Add Magzine</a>
   <% if (a != null  && !a.isEmpty()) {%>
        <div class="row" id="book-list">
            <% 
        		for (Magzine g : a) {
        			if ("yes".equals(g.getApprove())) 
        			{ %>
