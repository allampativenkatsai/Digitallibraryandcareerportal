...
ProjectCrud pr = new ProjectCrud();
ArrayList<Project> list = pr.read(branch);
%>

<div class="container">
    <h2>PROJECTS</h2>
 <a href="addp.html" class="add-button">Add Project</a>
    <% if (list != null && !list.isEmpty()) { %>
        <div class="row" id="book-list">
            <% for (Project p : list) {
                if (p != null && "yes".equals(p.getApporve())) { %>
    ...
    <% } else { %>
        <div class="no-books" id="no-books-message">
            <p>No Projects available for this branch.</p>
        </div>
    <% } %>
